...
export default function EntrenamientosAscensoScreen() {
  ...
  useEffect(() => {
    ...
    const fetchJugadoras = async () => {
      const jugadorasQuery = query(
        ...
        where('equipos', 'array-contains', 'jugadoras-ascenso')
      );
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Entrenamientos Ascenso</Text>
      {adminAutenticado && (
