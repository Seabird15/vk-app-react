...
type Props = NativeStackScreenProps<RootStackParamList, 'JugadorasEscuela'>;
...
export default function JugadorasEscuelaScreen({ navigation }: Props) {
  ...
  const fetchJugadoras = useCallback(async () => {
    try {
      setError('');
      const snap = await getDocs(collection(db, 'jugadoras-escuela'));
  ...
  return (
    <View style={styles.screen}>
      ...
      <Text style={styles.title}>Jugadoras - Escuela VK</Text>
